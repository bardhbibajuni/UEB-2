...
<div class="home-container">
    <div>
        ...
        <div style="margin-top:35px;display:flex;flex-direction:column;gap:15px;align-items:center;">
            ...
            <?php else: ?>
                <a href="courses.php">
                    <button class="btn" style="background:linear-gradient(135deg,#00ffff,#6366f1);">Browse Courses</button>
                </a>
            <?php endif; ?>
        </div>
    </div>
...
<div class="courses-section">
    <h2 class="section-title"><?= isset($_SESSION['user']) ? 'Available Courses' : 'Featured Courses' ?></h2>
    ...
    <div class="courses-grid">
        ...
        <div class="course-card">
            ...
            <?php if (isset($_SESSION['user'])): ?>
                ...
                $purchased = ($userId && $courseId) ? hasPurchased($userId, $courseId) : false;
                ?>
